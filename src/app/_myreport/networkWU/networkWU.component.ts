...
@Component({
  selector: 'app-networkwupie',
  templateUrl: './networkWU.component.html',
  styleUrls: ['../myreport.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NetworkWUComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.apiService.getReports(pdata).subscribe(data=>{
      ...
      result_arr.title="Network Wise Utilization";
      result_arr.subtitle="";
      result_arr.name="NETWORK DESCRIPTION";
