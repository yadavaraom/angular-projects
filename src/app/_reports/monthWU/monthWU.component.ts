...
@Component({
  selector: 'app-monthwu',
  templateUrl: './monthWU.component.html',
  styleUrls: ['../reports.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class MonthWUComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.apiService.getReports(pdata).subscribe(data=>{
        ...
        result.forEach(element => {
          result_arr_data.push([element.ClaimMonth,element.NetPaidClaimAmt]);
        });
