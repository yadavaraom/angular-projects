...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'dashboard',
        loadChildren: './_dashboard/app.dashboard.module#AppDashboardModule'
      },
      {
        path: 'chartbot',
        loadChildren: './_chartbot/chartbot.module#ChartbotModule'
      },


      // {
      //   path: 'myreport',
      //   loadChildren: './_myreport/myreport.module#MyReportModule'
      // },
      ...
      {
        path: 'master',
        loadChildren: './_admin/master.module#MasterModule'
      },
      // {
      //   path: 'role',
      //   loadChildren: './_admin/roles/roles.module#RolesModule'
      // },

      // {
      //   path: 'permission',
      //   loadChildren: './_admin/permission/permission.module#PermissionModule'
      // },
